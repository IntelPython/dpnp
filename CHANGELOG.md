...
* Resolved deadlock in `dpnp.linalg.qr` by releasing GIL before OneMKL `orgqr` call to prevent host tasks contention [#2850](https://github.com/IntelPython/dpnp/pull/2850)
