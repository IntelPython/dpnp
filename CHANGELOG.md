...
This release completes implementation of `dpnp.fft` module and adds array manipulation, indexing and elementwise routines. Moreover, it adds support to build `dpnp` for Nvidia GPUs is added.
