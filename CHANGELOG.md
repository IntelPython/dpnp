...
* Fixed `dpnp.nonzero`, `dpnp.where`, `dpnp.extract`, `dpnp.place` and `dpnp.repeat` returning wrong results for a boolean array whose bytes are not `0x00`/`0x01`, e.g. a `view` of integer data [#3053](https://github.com/IntelPython/dpnp/pull/3053)
