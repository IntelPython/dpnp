...
class TestDot:
    ...
    # Use both integer and float, to test both MKL and dpctl backends
...
class TestMatmul:
    ...
    @pytest.mark.parametrize("dtype", [numpy.int64, numpy.float32])
    def test_large_values(self, dtype):
        a = numpy.array(
            [[[94906267, 94906267], [94906267, 94906267]]], dtype=dtype
        )
