...
class TestSquare:
    ...
    def test_square(self, dtype):
        ...
        iout = dpnp.empty(expected.shape, dtype=out_dtype)
        result = dpnp.square(ia, out=iout)
