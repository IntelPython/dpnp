...
class TestMatMul(unittest.TestCase):
    ...
    def test_matmul3(self):
        ...
        # DPNP
        array1 = inp.array(array_data, dtype=inp.float64)
        array2 = inp.array(array_data, dtype=inp.float64)
        out1 = inp.array(out, dtype=inp.float64)
        result = inp.matmul(array1, array2, out=out1)
        # print(result)

        # original
        array_1 = numpy.array(array_data, dtype=numpy.float64)
        array_2 = numpy.array(array_data, dtype=numpy.float64)
